...
fileinput_gkl:
	gcc -O3 -fopenmp -mtune=native -march=native -mcmodel=medium -std=c99 -o fileinput_gkl fileinput_gkl.c lib/dlasru.o lib/dbdsqru.o src/CGS2.o src/DGEBRDG_4_BISIDE.o src/DGEBRDG_K.o src/DGEBRDG_LP1.o src/ERR.o src/GKL.o src/RESGKL.o lib/doqds1.o lib/doqds2.o lib/dlartg2.o lib/dlartg3.o lib/dlartg4.o lib/dlartg5.o lib/dlartg6.o lib/dlartg7.o lib/dfma0.o src/RESGKL_MAIN.o ${LIB2}
