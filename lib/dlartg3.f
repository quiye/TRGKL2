*> \brief \b DLARTG3 generates a plane rotation with real cosine and real sine.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DLARTG3( F, G, CS, SN, R )
* 
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DLARTG3 generate a plane rotation so that
*>
