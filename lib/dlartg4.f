*> \brief \b DLARTG4 generates a plane rotation with real cosine and real sine.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DLARTG4( F, G, CS, SN, R )
* 
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DLARTG4 generate a plane rotation so that
*>
