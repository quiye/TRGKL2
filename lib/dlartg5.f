*> \brief \b DLARTG5 generates a plane rotation with real cosine and real sine.
*
*  =========== DOCUMENTATION ===========
*
...
*  ===========
*
*       SUBROUTINE DLARTG5( F, G, CS, SN, R )
*
*       .. Scalar Arguments ..
...
*> \verbatim
*>
*> DLARTG5 generate a plane rotation so that
*>
